...
<div class="row">
 ...
 <h2>Edit Candidate</h2>
            <!-- form start -->
            <form role="form" action="{{route('candidate.update')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter Name" value="{{ $candidate->name }}">
                        </div>
                      </div>
                      @error('name')
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Enter email" value="{{ $candidate->email }}">
                        </div>
                      </div>
                      @error('email')
                      <div class="alert alert-danger">{{ $message }}</div>
